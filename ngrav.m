function [ng,dngdfi] =ngrav(fi);
%NGRAV    :Normal gravity value of a point on Geodetic Reference System 1980 (GRS80) ellipsoid using 
%         Somigliana's formula.
%        
%         NGRAV(fi) computes the normal gravity value (in m/sec^2 unit) and
%         its derviative (with respect to latitude) of a point with the
...
%         the derivative is derived by Mehdi Eshagh, Geodesy Division,
%         Royal Institute of Technology, Stockholm, Sweden, 2006
%                 Web page:www.mehdieshagh.blogspot.com
%
%         ______________________________________________________________________________________________
%
...
dngdfi	= nge*sqrt(1-b)*a*(2*k+e2*(1-k*b))/(1-e2*b)^1.5;
