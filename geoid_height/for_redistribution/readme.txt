...
. Deploy geoid_height.ctf to a server instance
. Develop a client application to access the functions.

1. Deploy geoid_height.ctf

1.1 Prerequisites to Deployment
Before you can deploy geoid_height.ctf you need a server instance to host it. The server 
...
1.2 geoid_height.ctf Deployment
To deploy geoid_height.ctf copy it into the server instance's `auto_deploy` folder. The 
